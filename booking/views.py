...
import math
from .models import *
from flight.utils import render_to_pdf, createticket


#Fee and Surcharge variable
from .constant import FEE
from booking.utils import createWeekDays, addPlaces, addDomesticFlights, addInternationalFlights
...
def flight(request):
    ...
    if trip_type == '2':
        ...
        flightday2 = Week.objects.filter(number=return_date.weekday()) ##
        origin2 = Place.objects.filter(code=d_place.upper())   ##
        destination2 = Place.objects.filter(code=o_place.upper())  ##
