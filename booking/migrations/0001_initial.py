# Generated by Django 5.0.2 on 2024-04-25 13:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='booking.place')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='booking.place')),
                ('depart_day', models.ManyToManyField(related_name='flights_of_the_day', to='booking.week')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='booking.flight')),
                ('passengers', models.ManyToManyField(related_name='flight_tickets', to='booking.passenger')),
